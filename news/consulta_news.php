...
$cons_data_publicacao  = isset($_REQUEST['txt_cons_data_publicacao']) ? $_REQUEST['txt_cons_data_publicacao'] : '';
...
<form name="frm_consulta" action="consulta_news.php" method="post">
  ...
  <div class="linha"> 
    ...
    <div class="coluna_03"> <strong> Autor </strong></div>
...
<?php while ($dados = mysqli_fetch_array($sql)) { ?>
  ...
  <div class="linha"> 
    ...
    <div class="coluna_03"> <?php echo $dados['new_autor']; ?> </div>
    <div class="coluna_02"> <?php echo $dados['new_status']; ?> </div>

...
$sql = "select *, date_format(cli_data_nascimento,'%d/%m/%Y') as data_nascimento, date_format(cli_data_cadastro,'%d/%m/%Y') as data
        from tb_cliente
...
<form name="frm_consulta" action="consulta_cliente.php" method="post">
    ...
    <input name="txt_cons_data_nascimento" type="text" placeholder="data_nascimento">
  ...
  <div class="linha"> 
    ...
    <div class="coluna_02"> <strong> Nascimento </strong></div>
    <div class="coluna_03"> <strong> E-mail </strong></div>
